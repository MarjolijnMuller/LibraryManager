...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtService jwtService, UserDetailsService userDetailsService, ProfileService profileService, LoanService loanService, PasswordEncoder passwordEncoder) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/invoices/{invoiceId}").hasAnyRole("LIBRARIAN", "ADMIN")
                        ...
                        // Loans - Aangepaste regels
                        // Specifieke regels voor members bovenaan plaatsen
