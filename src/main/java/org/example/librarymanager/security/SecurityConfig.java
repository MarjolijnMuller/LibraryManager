    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/profiles", "/profiles/**").hasAnyRole("LIBRARIAN", "ADMIN")
                        ...
                        .requestMatchers("/books/copies", "/books/copies/*").hasAnyRole("LIBRARIAN", "ADMIN")
                        .requestMatchers("/fines", "/fines/*").hasAnyRole("LIBRARIAN", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/loans/generate").hasAnyRole("LIBRARIAN", "ADMIN")
                        .requestMatchers("/loans", "/loans/*").hasAnyRole("LIBRARIAN", "ADMIN")
                        .requestMatchers("/invoices", "/invoices/*").hasAnyRole("LIBRARIAN", "ADMIN")


                        .requestMatchers(HttpMethod.GET, "/loans", "/loans/*").authenticated()
